...
class Khaossweeper < Formula
  ...
  on_macos do
    if Hardware::CPU.arm?
      url "https://github.com/Stenstromen/khaossweeper/releases/download/v1.0.0/khaossweeper_Darwin_arm64.tar.gz"
  ...
  on_linux do
    if Hardware::CPU.arm? && Hardware::CPU.is_64_bit?
      url "https://github.com/Stenstromen/khaossweeper/releases/download/v1.0.0/khaossweeper_Linux_arm64.tar.gz"
